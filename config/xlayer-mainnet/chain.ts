...
export const STABLE_TOKEN_PAIRS = ['0x89608d3dac35d535180f18d2c302a7b4b87f3c75', '0x3536dea603c3ce2c0256e467906d3f600918237d']
...
export const STATIC_TOKEN_DEFINITIONS: TokenDefinition[] = [
  ...
  {
    address: Address.fromString('0x779ded0c9e1022225f8e0630b35a9b54be713736'),
    symbol: 'USD₮0',
    name: 'USD₮0',
    decimals: BigInt.fromI32(6),
  },
